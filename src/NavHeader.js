    ...
    <>
      <nav id='navheader'>
        <div className="link">
          ...
          <div className='style_link_category' onMouseOver={add_class} onMouseOut={remove_class} >
            <div className='li_category'>
              Category
            </div>
            <div id='category_ul'>
              <ul>
                <li className="catLi"><Link className="nav-link">Richelieu</Link></li>
                <li className="catLi"><Link className="nav-link">Derby</Link></li>
                <li className="catLi"><Link className="nav-link">Chaussures à boucles</Link></li>
                <li className="catLi"><Link className="nav-link">Brogues</Link></li>
                <li className="catLi"><Link className="nav-link">Mocassins</Link></li>
                <li className="catLi"><Link className="nav-link">bateaux</Link></li>
                <li className="catLi"><Link className="nav-link">Deserts boots</Link></li>
                <li className="catLi"><Link className="nav-link">Chukka boots</Link></li>
                <li className="catLi"><Link className="nav-link">Chelsea boots</Link></li>
                <li className="catLi"><Link className="nav-link">Boots</Link></li>
              </ul>
            </div>
          </div>
